...
import { DemoDashboardTile} from './demo_tile'
...
class JtDashboard extends Component {
    setup(){
            ...
            if ($('.o_dynamic_dashboard')[0]){
                ...
                for (let i = 0; i < response.length; i++) {
                    if (response[i].type === 'tile'){
                        mount(DemoDashboardTile, $('.o_dynamic_dashboard')[0], { props: {
...
JtDashboard.template = "owl.DashboardTemplate";
actionRegistry.add("owl.jt_dashboard_tag", JtDashboard);