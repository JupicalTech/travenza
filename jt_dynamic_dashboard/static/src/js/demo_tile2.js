...
export class DemoDashboardTile2 extends Component {
...
DemoDashboardTile2.template = xml`
<div t-if="this.props.widget.tiles_type === '1'" class="col-lg-6  tile block">
...
<div t-if="this.props.widget.tiles_type === '3'" class="col-lg-6  tile block">
...
<div t-if="this.props.widget.tiles_type === '4'" class="col-lg-6  tile block">
